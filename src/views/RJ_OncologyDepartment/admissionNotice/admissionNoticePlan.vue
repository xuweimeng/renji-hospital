  ...
  <div class='app-container'>
    ...
    <el-card  style="margin-bottom:10px">
      ...
      <el-card shadow="never">
					<el-table border  fit highlight-current-row :data='dataList' style='width: 100%' ref='multipleTable' v-loading='hzLoading'>
  ...
  export default {
    ...
    methods: {
      getCurrent() {
        ...
        const currentTime1 = currentYear + '-' + currentMonth + '-' + startDate;
