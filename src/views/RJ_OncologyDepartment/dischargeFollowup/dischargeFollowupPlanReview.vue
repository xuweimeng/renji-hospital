  ...
  <div class="app-container">
    <!-- 查询 -->
      ...
      <li class="common_search_single">
        ...
        <el-input v-model='formInline.beginAge' placeholder='0'></el-input>
        -
        <el-input v-model='formInline.endAge'></el-input>
      </li>
      <li class="common_search_single">
	...
	<plan
    :planDg="planDg"
    @closeChildrenPlan="closeChildrenPlan">
  </plan>
  </div>
</template>
<script>
