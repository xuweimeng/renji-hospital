  ...
  <div class="app-container">
    <!-- 搜索 -->
      ...
      <li class="common_search_single">
        ...
        <el-input v-model.trim="formInline.brxm" clearable placeholder="请输入姓名"></el-input>
      </li>
      <li class="common_search_single">
      ...
      <li class="common_search_single">
        ...
        <el-input v-model.trim="formInline.schemeName" clearable placeholder="请输入通知方案"></el-input>
      </li>
      <li class="common_search_single">
       ...
       <li class="common_search_single common_search_single_date">
        ...
        <label class="radio-label" >通话状态</label>
			...
			<li class="common_search_single" v-if="tabIndex==1">
    ...
    <el-card shadow="never">
			<el-tabs v-model="activeName" @tab-click="handleClick">
				<el-tab-pane label="待处理" name="first">
					<el-table :data="tableData" border  fit highlight-current-row style="width: 100%;" v-loading="loading">
				...
				<el-tab-pane label="已处理" name="second">
					<el-table :data="tableData1" border  fit highlight-current-row style="width: 100%;" v-loading="loading1">
						<el-table-column prop="brxm" label="姓名" align="center"></el-table-column>
						<el-table-column prop="mobile" label="联系电话" align="center" show-overflow-tooltip></el-table-column>
						<el-table-column label="性别/年龄" align="center" width="110">
							<template slot-scope="scope">
