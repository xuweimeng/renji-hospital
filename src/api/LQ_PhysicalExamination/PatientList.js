 ...
 */
  ...
  /**
   * 修改死亡接口
   * hzxxId:bebd6df3-9857-4e2a-99a7-24bee9541e55,
   * isDed:1     0代表正常，1代表死亡
   */
  updateIsLive(data) {
  ...
  /**
   * @function 上传患者资料
   * @param  {type} uploadPat: '/doctors/excel/import' {description}
   * @param  {type}                                    {description}
   * @return {type} {description}
   */
  uploadPat: '/doctors/excel/import',
  /**
   * @function 下载患者模板
   * @param  {type} downloadPat: '/assets/templatedoc/customerTemp.xls' {description}
   * @param  {type}                                                     {description}
   * @return {type} {description}
   */
  downloadPat: '/assets/templatedoc/customerTemp.xls',
  /**
   * @function 下载错误模板
   * @param  {type} downloadErr: '/assets/templatedoc/customerError.xls' {description}
   * @return {type} {description}
   */
  downloadErr: '/assets/templatedoc/customerError.xls'
};
